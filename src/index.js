...
export { default as CollapseItem } from './collpase/collapse-item'
export { default as Collapse } from './collpase/collapse'
...
export { default as TabsPage } from './tabs/tabs-pane'
